...
<body>
    ...
    <div id="home-section-3" class="trailers-section">
        ...
        <div class="trailers-grid">
            ...
            <div class="trailers-grid-item">
                <img src="img/movie-thumb-222.jpg" alt="">
                <div class="trailer-item-info" data-video="Cv-6cAHanZ8?si">
                    <h3>Laila Majnu</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
            ...
            <div class="trailers-grid-item">
                <img src="img/movie-thumb-444.jpg" alt="">
                <div class="trailer-item-info" data-video="8FkLRUJj-o0?si">
                    <h3>Animal</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
